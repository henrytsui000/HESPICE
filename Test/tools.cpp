...
void tools::getCofactor(std::complex<double> **mat, std::complex<double> **cof, int p, int q, int n)
{
    using namespace std;
    int row=0,col=0;
    for(int i=0;i<n;i++){
...
std::complex<double> tools::getDeterminant(std::complex<double> **mat, int n)
{
    using namespace std;
...
void tools::getAdjoint(std::complex<double> **mat, std::complex<double> **adj,int n)
{
    using namespace std;
    if(n==1){
        adj[0][0]=1;
...
bool tools::getInverse(std::complex<double> **mat, std::complex<double> **inv,int n)
{
    using namespace std;
